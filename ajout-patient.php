...
<div class="container-fluid centerPage text-center">
    ...
    <div class="col justify-content-center">
        <div class="col-sm-6 bg-light border shadowblock">
            <h1 class="text-center">Ajout d'un patient</h1>
            ...
            <form action="" method="post">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-3d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary mt-5 mb-3" id='myButton' name="myButton">Valider le patient</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Le nouveau patient a bien été enregistré !
      </div>
